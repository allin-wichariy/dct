<?php /* Smarty version 2.6.9, created on 2014-09-01 18:47:29
         compiled from mat_via2.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<body>
	<?php if ($this->_tpl_vars['error'] == '1'): ?>
		<h2>AUN NO APROBARON NINGUN VIAJE</h2>
...
?>
	    	...
	    	<?php endif; ?>
		     <form name="forma">
			    ...
			    <td><?php echo $this->_tpl_vars['viajess'][$this->_sections['i']['index']]['id_dct_asignaciones']; ?>
</td>
			    ...
			    <td><?php echo $this->_tpl_vars['viajess'][$this->_sections['i']['index']]['pasajeros']; ?>
</td>
		      	<td align="center">
