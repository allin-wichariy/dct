<?php
  ...
  if($sms==0)
  {
    ...
    echo "<h3>GUARDADO CORRECTAMENTE-->AHORA YA PUEDE IMPRIMIR EL COMPROMISO PARA EL VIAJE</h3>";
  }
  else
    echo "<h3>POR FAVOR COMPLETE TODOS LOS CAMPOS Y LA SELECCION DE ESTUDIANTES </h3>";
  //echo "-".$tiene_crono;
