<?php /* Smarty version 2.6.9, created on 2015-07-02 11:14:12
         compiled from notas22.tpl */ ?>
<?php echo '
...
<form name=form method=post action='notas3.php'>
  <fieldset>
	<legend>Planilla de Notas G-<?php echo $this->_tpl_vars['descrip_grupo']; ?>
: <?php echo $this->_tpl_vars['id_periodo']; ?>
/<?php echo $this->_tpl_vars['id_gestion']; ?>
</legend>	
 ...
 <?php endif; ?></td>
	...
	<td><em><?php echo $this->_tpl_vars['descrip_codsef']; ?>
</em></td>
    </tr>
  </table>
  </fieldset>
...
<input type=hidden name='nro_dip<?php echo $this->_sections['i']['iteration']; ?>
' value='<?php echo $this->_tpl_vars['alumnos'][$this->_sections['i']['index']]['nro_dip']; ?>
'></td>
	<td align=left><?php echo $this->_tpl_vars['alumnos'][$this->_sections['i']['index']]['nombre']; ?>
<input type=hidden name='nombre<?php echo $this->_sections['i']['iteration']; ?>
' value='<?php echo $this->_tpl_vars['alumnos'][$this->_sections['i']['index']]['nombre']; ?>
'></td>
        <?php if ($this->_tpl_vars['parcial'] <> 0): ?>
	        <td><input size=3  id=pparcial<?php echo $this->_sections['i']['iteration']; ?>
...
');" <?php endif; ?>
		...
		<?php endif; ?>
	        ...
	        <td><input size=3 id=sparcial<?php echo $this->_sections['i']['iteration']; ?>
...
,<?php echo $this->_tpl_vars['ex_final']; ?>
 ...
 <?php if ($this->_tpl_vars['num_parc'] == 1): ?> style="visibility:hidden;" <?php endif; ?>>
		...
		<?php endif; ?>		
	        ...
	        <?php if ($this->_tpl_vars['num_parc'] == 3): ?>
	    	    <td><input size=3 id=tparcial<?php echo $this->_sections['i']['iteration']; ?>
...
>
		    ...
		    <td><input size=3 id=cparcial<?php echo $this->_sections['i']['iteration']; ?>
...
>
	        ...
	        <?php endif; ?>
	        <td><input size=3 type=text id=promparcial<?php echo $this->_sections['i']['iteration']; ?>
...
'>
	...
	<?php if ($this->_tpl_vars['practicas'] <> 0): ?>
	        <?php if ($this->_tpl_vars['tipo_calificacion'] == 'N'): ?>    
	    	    <td><input size=3 id=pract<?php echo $this->_sections['i']['iteration']; ?>
...
>
	        ...
	        <?php endif; ?>
	        <td><input size=3 id=prompract<?php echo $this->_sections['i']['iteration']; ?>
...
'></td>
	...
	<?php if ($this->_tpl_vars['laboratorio'] <> 0): ?>
	        <?php if ($this->_tpl_vars['tipo_calificacion'] == 'N'): ?>    
	    	    <td><input size=3 id=lab<?php echo $this->_sections['i']['iteration']; ?>
...
>
	        ...
	        <?php endif; ?>
	        <td>
	        <input size=3 id=promlab<?php echo $this->_sections['i']['iteration']; ?>
...
'>
	...
	<?php if ($this->_tpl_vars['ex_final'] <> 0): ?>
	      <?php if ($this->_tpl_vars['tipo_calificacion'] == 'N'): ?>
	      <td>
	      <input size=3 id=exfinal<?php echo $this->_sections['i']['iteration']; ?>
...
>
		...
		<?php endif; ?>		    		    		
	      ...
	      <?php endif; ?>
	      <td>
	      <input size=3 id=promexfinal<?php echo $this->_sections['i']['iteration']; ?>
...
'>
	      ...
	      <td>
	        ...
	        <input size=3 type=text id=nota<?php echo $this->_sections['i']['iteration']; ?>
...
>
		...
		<!---
		<input id=nota_2dae<?php echo $this->_sections['i']['iteration']; ?>
 name=nota_2dae<?php echo $this->_sections['i']['iteration']; ?>
 value='<?php echo $this->_tpl_vars['alumnos'][$this->_sections['i']['index']]['nota_2da']; ?>
' type=hidden>	 
		--->
	      </td>
