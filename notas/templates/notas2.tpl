...
<form name=form method=post action='notas3.php'>
  ...
  <table width='80%' align=center class="table table-striped TBODY" >
	...
	<td align=left>
        ...
        {if $parcial<>0}
	        <td><input size=3 data-toggle="tooltip" title="PRIMER PARCIAL" id=pparcial{$smarty.section.i.iteration} name=pparcial{$smarty.section.i.iteration}     value='{$alumnos[i].pparcial}'
		...
		{/if}
	        ...
	        <td><input size=3 data-toggle="tooltip" title="SEGUNDO PARCIAL" id=sparcial{$smarty.section.i.iteration} name=sparcial{$smarty.section.i.iteration}     value='{$alumnos[i].sparcial}'
				OnChange   ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
				OnFocus    ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
		...
		{/if}		
	        ...
	        {if $num_parc==3}
	    	    <td><input size=3 data-toggle="tooltip" title="TERCER PARCIAL" id=tparcial{$smarty.section.i.iteration} name=tparcial{$smarty.section.i.iteration}     value='{$alumnos[i].tparcial}'
				OnChange   ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
				OnFocus    ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
			type={$tipo3}>
		    {if $fechaSis>$fecha3} 
	        ...
	        {/if}
		{if $num_parc==4}
	    	    <td><input size=3 data-toggle="tooltip" title="T.PARCIAL" id=tparcial{$smarty.section.i.iteration} name=tparcial{$smarty.section.i.iteration}     value='{$alumnos[i].tparcial}'
				OnChange   ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
				OnFocus    ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
			type={$tipo3}>
		    {if $fechaSis>$fecha3} 
		    ...
		    <td><input size=3 data-toggle="tooltip" title="CUARTO PARCIAL" id=cparcial{$smarty.section.i.iteration} name=cparcial{$smarty.section.i.iteration}     value='{$alumnos[i].cparcial}'
				OnChange   ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
				OnFocus    ="calparc({$smarty.section.i.iteration},{$num_parc},'{$tipo_calificacion}',{$anulacion_parc},{$parcial},{$practicas},{$laboratorio},{$ex_final})"
			type={$tipo4}>
		    {if $fechaSis>$fecha4} 
	        ...
	        {/if}
	        <td><input size=3 type=text data-toggle="tooltip" title="PROMEDIO PARCIALES" class="itxt" id=promparcial{$smarty.section.i.iteration}  name=promparcial{$smarty.section.i.iteration}  value='{$alumnos[i].promparcial}'>
	...
	{if $practicas<>0}
	        {if $tipo_calificacion=="N"}    
	    	    <td><input size=3 data-toggle="tooltip" title="PRACTICAS" id=pract{$smarty.section.i.iteration} name=pract{$smarty.section.i.iteration} value='{$alumnos[i].pract}'
	        ...
	        {/if}
	        <td><input size=3 data-toggle="tooltip" title="PROMEDIO PRACTICAS"  id=prompract{$smarty.section.i.iteration} name=prompract{$smarty.section.i.iteration} value='{$alumnos[i].prompract}'
	    			OnChange   ="calplf(1,{$smarty.section.i.iteration},'{$tipo_calificacion}',{$parcial},{$practicas},{$laboratorio},{$ex_final})"
				OnFocus    ="calplf(3,{$smarty.section.i.iteration},'{$tipo_calificacion}',{$parcial},{$practicas},{$laboratorio},{$ex_final})"
		    type={$tipof}>
		{if $fechaSis>$fechaf} 
	...
	{if $laboratorio<>0}
	        { if $tipo_calificacion=="N" }    
	    	    <td><input size=3 data-toggle="tooltip" title="LABORATORIO" id=lab{$smarty.section.i.iteration} name=lab{$smarty.section.i.iteration} value='{$alumnos[i].lab}'
	        ...
	        {/if}
	        <td>
	        <input size=3 data-toggle="tooltip" title="PROMEDIO LABORATORIO"  id=promlab{$smarty.section.i.iteration} name=promlab{$smarty.section.i.iteration} value='{$alumnos[i].promlab}'
	    			OnChange   ="calplf(2,{$smarty.section.i.iteration},'{$tipo_calificacion}',{$parcial},{$practicas},{$laboratorio},{$ex_final})"
				OnFocus    ="calplf(3,{$smarty.section.i.iteration},'{$tipo_calificacion}',{$parcial},{$practicas},{$laboratorio},{$ex_final})"
			type={$tipof}>
		    {if $fechaSis>$fechaf} 
	...
	{if $ex_final<>0}
	      {if $tipo_calificacion=="N"}
	      <td>
	      <input size=3 data-toggle="tooltip" title="EXAMEN FINAL" id=exfinal{$smarty.section.i.iteration} name=exfinal{$smarty.section.i.iteration} value='{$alumnos[i].exfinal}'
		...
		{/if}		    		    		
	      ...
	      {/if}
	      <td>
	      <input size=3 data-toggle="tooltip" title="PROMEDIO EXAMEN FINAL"  id=promexfinal{$smarty.section.i.iteration}  name=promexfinal{$smarty.section.i.iteration}  value='{$alumnos[i].promexfinal}'
	    			OnChange   ="calplf(3,{$smarty.section.i.iteration},'{$tipo_calificacion}',{$parcial},{$practicas},{$laboratorio},{$ex_final})"
		...
		>
	      ...
	      <td>
	        ...
	        <input size=3 type=text data-toggle="tooltip" title="NOTA FINAL" id=nota{$smarty.section.i.iteration} name=nota{$smarty.section.i.iteration} 	    value='{$alumnos[i].nota}' disabled>
	      ...
	      <td>
            {if $id_periodo<>'3'}
	        <input id=nota_2dae{$smarty.section.i.iteration} data-toggle="tooltip" title="NOTA 2DO TURNO" size=3 name=nota_2dae{$smarty.section.i.iteration}  value='{$alumnos[i].nota_2da}' type={$tipof} {$alumnos[i].enabled}>	 
            {/if}
	        <!---
		...
		{/if}
		<!---
		<input id=nota_2dae{$smarty.section.i.iteration} size=3 name=nota_2dae{$smarty.section.i.iteration} value='{$alumnos[i].nota_2da}' type=hidden>	 
		--->
	      </td>
	    </tr>  
	    {if $sistema=="N"}
