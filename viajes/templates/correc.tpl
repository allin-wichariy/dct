...
<body>
	<h2>SE REGISTRO CORRECTAMENTE EL VIAJE AHORA VUELA A VIAJES SI DESEA IMPRIMIR EL FORMULARIO DE REGISTRO <a href="viajes1.php">Imprimir Viaje Registrado</a></h2>
