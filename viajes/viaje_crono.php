...
<body>
  ...
  <form id="form">
  <h2 align="center">HORA DE PARTIDA Y REGRESO DEL VIAJE</h2>
  <table align="center">
    <tr>
  ...
  <h2 align="center">LLENE EL CRONOGRAMA PARA LOS DIAS DEL VIAJE</h2>
  <table align="center">
    <?php
    if($tiene_crono==1)
    {
  ...
  <h2 align="center">CONFIRME QUE ESTUDIANTES DE SU MATERIA REALIZARAN EL VIAJE</h2>
