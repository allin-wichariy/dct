<?php
  ...
  where a.id_dct_asignaciones=v.id_dct_asignaciones and a.id_docente='$id_docente' and a.id_gestion='$id_gestion' and a.id_periodo='$id_periodo' and m.id_materia=a.id_materia and v.crono='T' order by id_viaje";
        //die($sql);
  //die($sql);
  $f->Ejecutar($sql);
  if ($f->filas == 0){
