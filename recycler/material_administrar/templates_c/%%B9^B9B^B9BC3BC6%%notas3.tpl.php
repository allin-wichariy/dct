<?php /* Smarty version 2.6.9, created on 2012-09-10 16:45:46
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['materiales']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
	...
	<td align=left width='15%'><?php echo $this->_tpl_vars['materiales'][$this->_sections['i']['index']]['archivo']; ?>
</td>
	<td align=center width='8%' ><?php echo $this->_tpl_vars['materiales'][$this->_sections['i']['index']]['fecha_publicacion']; ?>
</td>
	<td align=center width='5%' ><?php echo $this->_tpl_vars['materiales'][$this->_sections['i']['index']]['hora_publicacion']; ?>
</td>
	<td align=center width='5%' ><?php echo $this->_tpl_vars['materiales'][$this->_sections['i']['index']]['estado']; ?>
</td>
	<td align=center width='5%'><input type = checkbox name=elegida<?php echo $this->_sections['i']['iteration']; ?>
 value=<?php echo $this->_tpl_vars['materiales'][$this->_sections['i']['index']]['id_dct_asig']; ?>
>
       </tr>  
 <?php endfor; endif; ?>
</table>
        ...
        <input name=filas  type=hidden value=<?php echo $this->_tpl_vars['filas']; ?>
>
